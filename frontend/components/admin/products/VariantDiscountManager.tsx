              ...
              <div className="space-y-2">
                ...
                {tiers.length === 0 ? (
                  <div className="rounded-md border border-dashed p-6 text-center text-sm text-muted-foreground">
                    Sin niveles — haz clic en "Agregar nivel" para comenzar
                  </div>
                ) : (
                  <>
                    {/* Header labels */}
                    <div className="grid grid-cols-[1fr_1fr_80px_1fr_32px] gap-2 px-3 text-xs text-muted-foreground">
                    ...
                    {tiers.map((tier, index) => (
                      <div
                        key={index}
                        className="grid grid-cols-[1fr_1fr_80px_1fr_32px] gap-2 items-center rounded-md border bg-muted/20 px-3 py-2"
                      >
                        <Input
                          type="number"
                          min="1"
