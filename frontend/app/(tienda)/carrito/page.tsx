  ...
  if (itemCount === 0) {
    return (
      <EmptyState
        ...
        description="Agrega productos desde el catálogo para empezar tu pedido y aprovechar los descuentos por mayor."
        action={{ label: 'Explorar el catálogo', href: '/productos' }}
