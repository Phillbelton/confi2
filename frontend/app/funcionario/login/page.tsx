...
export default function FuncionarioLoginPage() {
  const { login, isLoggingIn } = useFuncionarioAuth();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-orange-100 dark:from-slate-900 dark:to-slate-800 p-4">
      <div className="w-full max-w-md">
        {/* Card */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl p-8 border border-orange-100 dark:border-slate-700">
          {/* Logo/Header */}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  {...form.register('email')}
                  type="email"
                  placeholder="funcionario@quelita.com"
