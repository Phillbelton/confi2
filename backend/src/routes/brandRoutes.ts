...
router.put('/:id', authenticate, authorize('admin', 'funcionario'), validate(brandSchemas.updateBrandSchema), auditLog('brand', 'update'), brandController.updateBrand);

// Protected routes (admin only)
router.delete('/:id', authenticate, authorize('admin'), validate(brandSchemas.deleteBrandSchema), auditLog('brand', 'delete'), brandController.deleteBrand);
